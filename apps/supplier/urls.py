...
urlpatterns = [
    ...
    path(
        "purchase-orders-list/", views.purchase_orders_list, name="purchase-orders-list"
    ),
    path(
        "purchase-orders/add/", views.purchase_order_add, name="purchase_order_create"
    ),
    path(
        "purchase-orders/update/<int:purchase_order_id>/",
        views.purchase_order_update,
        name="purchase-order-update",
    ),
    path(
        "purchase-orders/delete/<int:purchase_order_id>/",
    ...
    path(
        "purchase-order/<int:pk>/update-status/",
        views.purchase_order_update_status,
