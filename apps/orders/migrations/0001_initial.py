    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Out for Delivery', 'Out for Delivery'), ('Delivered', 'Delivered'), ('Canceled', 'Canceled'), ('Refunded', 'Refunded'), ('Returned', 'Returned')], max_length=20)),
                ('payment_method', models.CharField(choices=[('Mobile Money', 'Mobile Money')], default='MTN MOMO', max_length=20)),
